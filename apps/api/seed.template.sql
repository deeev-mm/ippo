...
INSERT INTO users (id, name, password_hash, avatar, theme, role, created_at, updated_at) VALUES
  ('seed-user-parent', 'parent', '__DEMO_PASSWORD_HASH__', 'UserRound', 'blue', 'parent', datetime('now'), datetime('now')),
  ('seed-user-taro', 'taro', '__DEMO_PASSWORD_HASH__', 'Rocket', 'blue', 'child', datetime('now'), datetime('now')),
  ('seed-user-hanako', 'hanako', '__DEMO_PASSWORD_HASH__', 'Cat', 'pink', 'child', datetime('now'), datetime('now'));
