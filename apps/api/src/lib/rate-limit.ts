...
export async function isLocked(db: Db, scope: string, identifier: string): Promise<boolean> {
  const row = await db
...
export async function recordFailure(db: Db, scope: string, identifier: string): Promise<void> {
...
export async function resetAttempts(db: Db, scope: string, identifier: string): Promise<void> {
  await db
